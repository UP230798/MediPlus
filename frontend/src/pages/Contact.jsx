    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='font-semibold text-lg text-gray-600'>Carreras en MediPlus</p>
          <p className='text-gray-500'>Conozca más sobre nuestros equipos y vacantes.</p>
          <button className='border border-black px-8 py-4 text-sm cursor-pointer hover:bg-black hover:text-white transition-all duration-500'>Explorar Vacantes</button>
        </div>
