    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={()=> speciality === 'Pediatría' ? navigate('/doctors') : navigate('/doctors/Pediatría')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Pediatría" ? "bg-teal-100 text-black" : ""}`}>Pediatría</p>
          <p onClick={()=> speciality === 'Neurología' ? navigate('/doctors') : navigate('/doctors/Neurología')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Neurología" ? "bg-teal-100 text-black" : ""}`}>Neurología</p>
          <p onClick={()=> speciality === 'Gastroenterología' ? navigate('/doctors') : navigate('/doctors/Gastroenterología')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Gastroenterología" ? "bg-teal-100 text-black" : ""}`}>Gastroenterología</p>
        </div>
